...
def run_test_sum_more_cosines():
    ...
    # Test 3:
    expected = 0.26753  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(7, 21)
...
def run_test_count_sines_from():
    ...
    # Test 4:
    expected = 7
    answer = count_sines_from(8, 17)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 7
    answer = count_sines_from(17, 27)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 3
    answer = count_sines_from(27, 30)
